...
class AttachmentWebcamDialog extends Component {
    ...
    async onwebcam(base64, mimetype) {
        const file = await this.urltoFile('data:' + mimetype + ';base64,' + base64, 'snapshot.jpg', mimetype);
...
AttachmentWebcamDialog.template = 'attachments_manager.AttachmentWebcamDialog'
